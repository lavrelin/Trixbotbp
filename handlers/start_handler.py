...
async def show_write_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "💁‍♂️ Канал Будапешт: Объявления, новости, жалобы, сплетни, подслушанно.\n"
        "🕵🏽‍♀️ Канал Куплю/Отдам/Продам: главная барахолка Будапешта и 🇭🇺.\n\n"
        
        " *📂 Заявка в 🙅🏻‍♀️Каталог Услуг*\n"
        "#️⃣ Актуальный список специалистов разных направлений, отсортированный по #️⃣ для удобного поиска пользователем❕\n"
