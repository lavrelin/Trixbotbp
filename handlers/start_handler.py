...
async def show_main_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        "👋🏻 *Привет!*\n"
        "Уже слышал про 3✖️? Х❌Х❔ TRIX – это я❗️Но кто я⁉️\n"
        "*Трикс* – гид навигатор по Будапешту и Венгрии 🇭🇺.\n"
        "🗯️ *Наше сообщество*:\n"
        ...
        "Нажмите 🚶‍♀️‍➡️*Писать* и выбирайте раздел\n"
        "🏹 Быстро • ⚔️ Удобно • 🛡️ Безопасно\n"
        "🔒*Добавляйте Трикса в закрепы*"
    )
...
async def show_write_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    "Добавляйтесь в список специалистов Будапешта.\n"
    "Разные направления отсортированы по #️⃣ хештегам для удобного поиска пользователем❕\n"
